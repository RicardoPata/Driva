...
If this pattern is found, calculate percentual difference between lowest and highest point on that pattern, if its bigger than 1, looks for retracement, if retracement hits, set stop loss and target price . Send email once bet is on
